...
const TR: Record<string, string> = {
  ...
  "Schoolar accounts": "Schoolar hesapları",
  "Schoolar could not load": "Schoolar yüklenemedi",
  "Search": "Ara",
  ...
  "Who can find and open your Schoolar profile?": "Schoolar profilinizi kim bulabilir ve açabilir?",
