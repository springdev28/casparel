...
const TR: Record<string, string> = {
  ...
  "Connect notes, links, and Schoolar resources in a flexible workspace.": "Notları, bağlantıları ve Schoolar kaynaklarını esnek bir çalışma alanında birleştirin.",
