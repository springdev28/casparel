      ...
      <div className="p-4">
        {data.kind === "link" ? (
          ...
          <div className="space-y-2">
            <p className="line-clamp-3 text-xs leading-relaxed">{data.text || "Schoolar library resource"}</p>
    ...
    <NodeActionsContext.Provider value={nodeActions}>
      ...
      <Dialog open={resourceOpen} onOpenChange={setResourceOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader><DialogTitle>Add a library resource</DialogTitle><DialogDescription>Place an existing Schoolar resource directly on this canvas.</DialogDescription></DialogHeader>
