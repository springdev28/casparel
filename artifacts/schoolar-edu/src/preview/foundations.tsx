/**
 * @fileOverview Design-system role: implements or demonstrates Foundations in the shared component/token package.
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <section className="rounded-xl border bg-card p-5 text-card-foreground">
          ...
          <Card className="mt-4">
            <CardHeader>
              <CardTitle>Add resource to class</CardTitle>
              <CardDescription>
                Components composed from the EduDS tokens.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <Label htmlFor="overview-resource">Resource title</Label>
                <Input id="overview-resource" placeholder="e.g. Introduction to Algebra" />
              </div>
              <div className="flex items-center gap-2">
                <Switch defaultChecked id="overview-notify" />
                <Label htmlFor="overview-notify">Notify students</Label>
                <Badge className="ml-auto">Video</Badge>
              </div>
            </CardContent>
