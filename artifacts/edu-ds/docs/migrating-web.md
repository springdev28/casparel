# Migrating web UI to EduDS — Educational Design System

Read `artifacts/edu-ds/docs/AGENTS.md` and
`artifacts/edu-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/edu-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/edu-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/edu-ds/hooks/use-toast`
