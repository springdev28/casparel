import { pgEnum, pgTable, serial, integer, text, date, timestamp } from "drizzle-orm/pg-core";
import { usersTable } from "./users";

export const learningGoalStatusEnum = pgEnum("learning_goal_status", ["active", "paused", "completed"]);
export const learningGoalLevelEnum = pgEnum("learning_goal_level", ["beginner", "intermediate", "advanced"]);
